...
raw_df=spark.readStream\
    ...
    .option("subscribe", "flight-economy")\
...
query=cleaned_df.writeStream\
    ...
    .format("csv")\
    .option("header", "true")\
    .option("path", "hdfs://localhost:9000/user/sunbeam/cleaned_flight_data_economy")\
    .option("checkpointLocation", "hdfs://localhost:9000/user/sunbeam/chkpt_economy")\
